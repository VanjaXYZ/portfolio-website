...
const Work = () => {
  return (
    <section id="work" className="w-full space-y-6 bg-black">
      <h2 className="text-2xl font-bold text-start">Projects</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-20 place-items-center text-white">
